...
public class CadastroService {
    ...
    public String register(CadastroRequest request) {
        ...
        String token = usuarioService.signUsuario(
                new Usuario(
                        request.getNome(),
        ...
        String link = "http://localhost:8080/api/v1/cadastro/confirm?token=" + token;

        emailSender.send(request.getEmail(), buildEmail(request.getNome(), link));
        return token;
    }
    ...
    private String buildEmail(String name, String link) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                ...
                "                      <span style=\"font-family:Helvetica,Arial,sans-serif;font-weight:700;color:#ffffff;text-decoration:none;vertical-align:top;display:inline-block\">Confirme o email</span>\n" +
                "                    </td>\n" +
                "                  </tr>\n" +
                "                </tbody></table>\n" +
                "              </a>\n" +
